...
export class Route {
  ...
  private _blockClass: new (componentProps: IComponentProps) => Block
  ...
  constructor (
    pathname: string,
    view: new (componentProps: IComponentProps) => Block,
    props: IRouterProps,
    ...
    if (this.checkAuth()) {
      if (!this._block) {
        this._block = new this._blockClass({
          ...this._componentProps, router: { params: this.getParams() }
        })
